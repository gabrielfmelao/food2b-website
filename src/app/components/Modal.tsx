    ...
    return (
        <>
            {modal &&
                ...
                <dialog
                    className="fixed left-0 top-0 w-full h-full bg-black bg-opacity-50 z-50 overflow-auto backdrop-blur flex justify-center items-center p-4">
                    <div className="bg-white rounded-md w-[1000px] flex flex-col overflow-hidden md:flex-row h-full md:h-auto">
                        ...
                        <div className="p-8 w-full md:w-1/2 h-full">
                            <button className="flex md:hidden w-full flex-row-reverse">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-8 h-8  text-amber-400">
