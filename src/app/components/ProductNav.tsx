...
import Artboard1 from "../../../public/Arboard1.png"
import Artboard2 from "../../../public/Artboard2.png"
import Artboard3 from "../../../public/Artboard3.png"
                                ...
                                <button type="button" className="hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-200 p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-slate-900 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 active" id="tabs-with-card-item-1" data-hs-tab="#tabs-with-card-1" aria-controls="tabs-with-card-1" role="tab">
                                    <span className="flex">
                                        ...
                                        <span className="grow ms-6">
                                            <span className="block text-lg font-semibold hs-tab-active:text-amber-500 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Ferramentas Avançadas</span>
                                            <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">Tenha acesso completo à gestão dos seus pedidos, orçamentos, hierarquia de aprovação e muito mais</span>
                                        </span>
                                    </span>
                                </button>
                        ...
                        <div className="lg:col-span-6">
                            <div className="relative">
                                ...
                                <div className="hidden absolute top-0 end-0 translate-x-20 md:block lg:translate-x-20">
                                    <svg className="w-16 h-auto text-amber-500" width="121" height="135" viewBox="0 0 121 135" fill="none" xmlns="http://www.w3.org/2000/svg">
